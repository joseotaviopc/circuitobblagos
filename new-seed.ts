...
const resultadoMasterEtapa01New = [
  ...
  { atleta: "Paulo Victor Barros", categoria: "Master", posicao: 7, pontos: 555 },
...
const resultadoMasterEtapa03New = [
  ...
  { atleta: "Paulo Victor Barros", categoria: "Master", posicao: 9, pontos: 500 },
...
const resultadoMasterEtapa04New = [
  ...
  { atleta: "Guilherme Batista", categoria: "Master", posicao: 10, pontos: 488 },
...
const resultadoLegendEtapa04New = [
  ...
  { atleta: "Rafael Dorileo", categoria: "Legend", posicao: 0, pontos: 0 },
  { atleta: "Sergio Castanheira", categoria: "Legend", posicao: 7, pontos: 555 },
...
const resultadoSub15FemEtapa01New = [
  ...
  { atleta: "Gabriela Oliveira", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
  { atleta: "Emily Alves", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
  { atleta: "Alice Fonseca", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
  { atleta: "Ana Luiza Mangeli", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
];
...
const resultadoSub15FemEtapa03New = [
  { atleta: "Sophia Veiga", categoria: "Sub-15-Fem", posicao: 1, pontos: 1000 },
  { atleta: "Yone Fernandes", categoria: "Sub-15-Fem", posicao: 2, pontos: 860 },
  ...
  { atleta: "Gabriela Oliveira", categoria: "Sub-15-Fem", posicao: 4, pontos: 670 },
  { atleta: "Emily Alves", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
  { atleta: "Alice Fonseca", categoria: "Sub-15-Fem", posicao: 0, pontos: 0 },
  { atleta: "Ana Luiza Mangeli", categoria: "Sub-15-Fem", posicao: 7, pontos: 555 },
];
...
const resultadoSub15MascEtapa02New = [
  ...
  { atleta: "Kayllon Miguel", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
  { atleta: "Julio Cezar", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
  { atleta: "Marco Antonio", categoria: "Sub-15-Masc", posicao: 19, pontos: 390 },
  { atleta: "Nelvan Ferreira", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
  { atleta: "Irineu Correa", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
  { atleta: "Gabriel Aquino", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
  { atleta: "Arthur Leal", categoria: "Sub-15-Masc", posicao: 0, pontos: 0 },
...
const resultadoSub12MascEtapa01New = [
  ...
  { atleta: "Lucas Alcantara", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Vinicius Nascimento", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  ...
  { atleta: "Bernardo Dos Anjos", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
...
const resultadoSub12MascEtapa02New = [
  ...
  { atleta: "Nicolas Chalfun", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Joao Marins", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Augusto Sigle", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Carlos Eduardo", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Davi Carvalho Barbosa", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
];

const resultadoSub12MascEtapa03New = [
  { atleta: "Nyas Chalfun", categoria: "Sub-12-Masc", posicao: 2, pontos: 860 },
  { atleta: "David Martins", categoria: "Sub-12-Masc", posicao: 7, pontos: 555 },
  { atleta: "Henrique Gaglionelli", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Lucca Garcia", categoria: "Sub-12-Masc", posicao: 5, pontos: 610 },
  { atleta: "Bernardo Brito", categoria: "Sub-12-Masc", posicao: 1, pontos: 1000 },
  { atleta: "Rafael Silva", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Miguel Silva", categoria: "Sub-12-Masc", posicao: 3, pontos: 730 },
  { atleta: "Vitinho", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Lucas Alcantara", categoria: "Sub-12-Masc", posicao: 4, pontos: 670 },
  { atleta: "Vinicius Nascimento", categoria: "Sub-12-Masc", posicao: 5, pontos: 610 },
  { atleta: "Lucas Coelho", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Guilherme Perre", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Enzo Cabreira", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Brayan Martins", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  ...
  { atleta: "Bernardo Dos Anjos", categoria: "Sub-12-Masc", posicao: 7, pontos: 555 },
  { atleta: "Tomze Muller", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Nicolas Chalfun", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Joao Marins", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Augusto Sigle", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
  { atleta: "Carlos Eduardo", categoria: "Sub-12-Masc", posicao: 10, pontos: 488 },
  { atleta: "Davi Carvalho Barbosa", categoria: "Sub-12-Masc", posicao: 0, pontos: 0 },
];
...
const resultadoSub18MascEtapa01New = [
  ...
  { atleta: "Arthur Carvalho", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  ...
  { atleta: "Ratinho Jhon Jhon", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
...
const resultadoSub18MascEtapa03New = [
  { atleta: "Lucas Figueiredo", categoria: "Sub-18-Masc", posicao: 9, pontos: 500 },
  { atleta: "Matheus Figueiredo", categoria: "Sub-18-Masc", posicao: 1, pontos: 1000 },
  { atleta: "Joao Gabriel Carvalho", categoria: "Sub-18-Masc", posicao: 5, pontos: 610 },
  { atleta: "Leonardo Da Silva", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Luiz Breno", categoria: "Sub-18-Masc", posicao: 13, pontos: 450 },
  { atleta: "Guilherme Almeida", categoria: "Sub-18-Masc", posicao: 3, pontos: 730 },
  { atleta: "Guilherme Araujo", categoria: "Sub-18-Masc", posicao: 13, pontos: 450 },
  ...
  { atleta: "Alberto Jasmin", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Luan Azeredo", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Arthur Carvalho", categoria: "Sub-18-Masc", posicao: 4, pontos: 670 },
  { atleta: "Lucas Avellar", categoria: "Sub-18-Masc", posicao: 5, pontos: 610 },
  { atleta: "Daniel Silva", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Adenilson Santos", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Davi Araujo", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Caio Henrique", categoria: "Sub-18-Masc", posicao: 7, pontos: 555 },
  { atleta: "Atila Ferreira", categoria: "Sub-18-Masc", posicao: 7, pontos: 555 },
  { atleta: "Thiago Ladeira", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Ratinho Jhon Jhon", categoria: "Sub-18-Masc", posicao: 9, pontos: 500 },
  { atleta: "Luiz Gustavo", categoria: "Sub-18-Masc", posicao: 9, pontos: 500 },
  { atleta: "Joao Nunes", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Joao Gabriel Rodrigues", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Rafael Lorenzo", categoria: "Sub-18-Masc", posicao: 13, pontos: 450 },
  { atleta: "Matheus Machado Santos", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Luiz Guilherme", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
  { atleta: "Kauan Pereira", categoria: "Sub-18-Masc", posicao: 0, pontos: 0 },
...
//   { eventId: idEtapa04CaboFrio, eventName: nameEtapa04CaboFrio, results: resultadoProMascEtapa04New },
  ...
  { eventId: idEventoSaquarema, eventName: nameEventoSaquarema, results: resultadoSub12FemEtapa01New },
