...
export default function InstagramFeed() {
  useEffect(() => {
    ...
    // It loads the external Instagram embed script
  ...
  return (
    <>
      <div className="h-auto relative min-h-[450px]">
        <blockquote 
          className="instagram-media bg-background" 
          data-instgrm-permalink="https://www.instagram.com/circuitobblagos" 
          ...
          style={{
            ...
            padding: '0',
            width: '99.375%',
            height: 'undefined', // Note: You can't have 'undefinedpx' in CSS, so it's best to remove it or set a valid value
            maxHeight: '100%',
          }}
        >
          <div style={{ padding: '16px' }}>
            <a id="main_link" href="https://www.instagram.com/circuitobblagos" style={{ background: '#FFFFFF', lineHeight: '0', padding: '0', textAlign: 'center', width: '100%' }} target="_blank" rel="noopener noreferrer">
            ...
            {/* <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <a href="https://www.instagram.com/circuitobblagos" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">Shared post</a> on{' '} 
              <time style={{ fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px' }}>Time</time> 
            </p> */}
          </div>
        </blockquote>
      </div>
