							...
							<Card className="overflow-hidden">
								<CardHeader className="p-0 relative aspect-video">
									<Image
										...
										data-ai-hint="surfing action"
									/>
									<div className="absolute inset-0 bg-black/40 flex items-center justify-center">
										{item.type === "video" ? (
											<Clapperboard className="h-10 w-10 md:h-12 md:w-12 text-white/80" />
										) : (
											<GalleryHorizontal className="h-10 w-10 md:h-12 md:w-12 text-white/80" />
										)}
									</div>
								</CardHeader>
								<CardContent className="p-4">
									<h3 className="font-bold font-headline truncate">
										{item.title}
									</h3>
